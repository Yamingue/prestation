 ...
 */
final class Version20201010232147 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE demande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, service_id INTEGER DEFAULT NULL, tel INTEGER DEFAULT NULL, email VARCHAR(255) NOT NULL COLLATE BINARY, commentaire CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_2694D7A5A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2694D7A5ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__demande AS SELECT id, user_id, service_id, tel, email, commentaire FROM demande');
        $this->addSql('DROP TABLE demande');
        $this->addSql('CREATE TABLE demande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, service_id INTEGER DEFAULT NULL, tel INTEGER DEFAULT NULL, email VARCHAR(255) NOT NULL, commentaire CLOB NOT NULL)');
        $this->addSql('INSERT INTO demande (id, user_id, service_id, tel, email, commentaire) SELECT id, user_id, service_id, tel, email, commentaire FROM __temp__demande');
        $this->addSql('DROP TABLE __temp__demande');
        $this->addSql('CREATE INDEX IDX_2694D7A5A76ED395 ON demande (user_id)');
        $this->addSql('CREATE INDEX IDX_2694D7A5ED5CA9E6 ON demande (service_id)');
